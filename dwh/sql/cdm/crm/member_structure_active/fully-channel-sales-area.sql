INSERT INTO cdm_crm.member_structure_active (
    ...
    WITH
        ...
        total_active_member_type_frequency_member AS (
            ...
            GROUP BY computing_until_month, computing_duration, channel_type, sales_area, member_type, frequency_type
        ),
        ...
        total_active_member_type_member AS (
            ...
            GROUP BY computing_until_month, computing_duration, channel_type, sales_area, member_type
        ),
        --活跃重复购买新老客户
        ...
        total_active_n_repurchased_member_type_member AS (
            ...
            WHERE tamtm.computing_until_month = trmtm.computing_until_month AND
                ...
                tamtm.channel_type = trmtm.channel_type AND
                tamtm.sales_area = trmtm.sales_area AND
                tamtm.member_type = trmtm.member_type
            ORDER BY tamtm.computing_until_month, tamtm.computing_duration, tamtm.channel_type, tamtm.sales_area
        ),
        ...
        member_structure_active_old_duration_monetary_per_member AS (
            ...
            GROUP BY computing_until_month, computing_duration, channel_type, sales_area, member_no
        ),
        ...
        member_structure_active_old_recency_type_monetary_per_member AS (
            ...
            WHERE old.computing_until_month = bdmo.computing_until_month
                ...
                AND old.channel_type = bdmo.channel_type
                AND old.sales_area = bdmo.sales_area
                AND bdmo.store_region IS NULL
        ...
        total_active_old_recency_type_member AS (
            ...
            GROUP BY computing_until_month, computing_duration, channel_type, sales_area, recency_type
        )
