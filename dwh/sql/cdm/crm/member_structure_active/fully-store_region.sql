INSERT INTO cdm_crm.member_structure_active (
    ...
    WITH
        ...
        total_active_member_type_frequency_member AS (
            ...
            GROUP BY computing_until_month, computing_duration, store_region, member_type, frequency_type
        ),
        ...
        total_active_n_repurchased_member_type_member AS (
            ...
            ORDER BY tamtm.computing_until_month, tamtm.computing_duration, tamtm.store_region
        ),
        ...
        total_active_old_recency_type_member AS (
            ...
            GROUP BY computing_until_month, computing_duration, store_region, recency_type
        )
