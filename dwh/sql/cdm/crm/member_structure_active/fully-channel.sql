INSERT INTO cdm_crm.member_structure_active (
    ...
    WITH
        ...
        total_active_member_type_frequency_member AS (
            ...
            GROUP BY computing_until_month, computing_duration, channel_type, member_type, frequency_type
        ),
        ...
        total_active_member_type_member AS (
            ...
            GROUP BY computing_until_month, computing_duration, channel_type, member_type
        ),
        --活跃重复购买新老客户
        ...
        total_active_n_repurchased_member_type_member AS (
            ...
            ORDER BY tamtm.computing_until_month, tamtm.computing_duration, tamtm.channel_type
        ),
        ...
        member_structure_active_old_duration_monetary_per_member AS (
            ...
            GROUP BY computing_until_month, computing_duration, channel_type, member_no
        ),
        ...
        total_active_old_recency_type_member AS (
            ...
            GROUP BY computing_until_month, computing_duration, channel_type, recency_type
        )
