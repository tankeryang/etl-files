    SELECT DISTINCT
        ...
        cast(IF(
            ...
            IF(sm.sales_amount IS NOT NULL, sm.sales_amount, 0) * IF(
    ...
    ON
        mtl.sales_area = lyst.sales_area
    ...
    ON
        mtl.sales_area = new_vip.sales_area
    ...
    ON
        mtl.sales_area = new_normal.sales_area
