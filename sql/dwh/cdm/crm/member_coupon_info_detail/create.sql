...
CREATE TABLE IF NOT EXISTS cdm_crm.member_coupon_info_detail (
    ...
    coupon_batch_date    DATE           COMMENT '券绑定日期',
    coupon_batch_status  VARCHAR        COMMENT '券绑定状态',
    coupon_start_date    DATE           COMMENT '券开始日期',
    coupon_end_date      TIMESTAMP      COMMENT '券截止日期',
    coupon_used_order_no VARCHAR        COMMENT '券使用订单号',
    coupon_used_date     TIMESTAMP      COMMENT '券使用日期',
