...
DROP TABLE IF EXISTS ads_crm.member_analyse_income_member_now_before_all;


CREATE TABLE IF NOT EXISTS ads_crm.member_analyse_income_member_now_before_all (
    brand                   VARCHAR,
