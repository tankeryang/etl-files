...
DROP TABLE IF EXISTS ads_crm.member_analyse_income_member_new_old_zone_all;


CREATE TABLE IF NOT EXISTS ads_crm.member_analyse_income_member_new_old_zone_all (
    brand                   VARCHAR,
    zone                    VARCHAR,
    zone_type               VARCHAR,
    member_type             VARCHAR,
