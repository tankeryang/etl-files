DROP TABLE IF EXISTS cdm_crm.daliy_report_country_day;


CREATE TABLE IF NOT EXISTS cdm_crm.daliy_report_country_day (
    ...
    sales_amount_per_member             DECIMAL(18, 2)  COMMENT '人均销售金额',
    sales_item_quantity_per_member      DECIMAL(18, 2)  COMMENT '人均销售件数',
    su_per_member                       DECIMAL(18, 2)  COMMENT '人均SU',
