...
DROP TABLE IF EXISTS ads_crm.member_analyse_income_total_zone_weekly_all;


CREATE TABLE IF NOT EXISTS ads_crm.member_analyse_income_total_zone_weekly_all (
    brand                   VARCHAR,
