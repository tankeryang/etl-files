INSERT INTO ads_crm.member_recruit_analyse_fold_daily_income_detail
    ...
    AND t.vchr_date > (SELECT vchr_max_date FROM ads_crm.member_analyse_max_date)
    GROUP BY
        t.country,
        t.sales_area,
        t.sales_district,
    ...
    AND t1.vchr_date > (SELECT vchr_max_date FROM ads_crm.member_analyse_max_date)
    GROUP BY
        t1.country,
        t1.sales_area,
        t1.sales_district,
    ...
    AND t2.vchr_date > (SELECT vchr_max_date FROM ads_crm.member_analyse_max_date)
    GROUP BY
        t2.country,
        t2.sales_area,
        t2.sales_district,
