...
DROP TABLE IF EXISTS ads_crm.member_analyse_income_member_now_before_zone_all;


CREATE TABLE IF NOT EXISTS ads_crm.member_analyse_income_member_now_before_zone_all (
    brand                   VARCHAR,
    zone                    VARCHAR,
    zone_type               VARCHAR,
    member_type             VARCHAR,
