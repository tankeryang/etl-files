...
DROP TABLE IF EXISTS ads_crm.member_analyse_income_member_new_old_store_daily;


CREATE TABLE IF NOT EXISTS ads_crm.member_analyse_income_member_new_old_store_daily (
    brand                   VARCHAR,
    zone                    VARCHAR,
    member_type             VARCHAR,
