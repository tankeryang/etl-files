...
DROP TABLE IF EXISTS ads_crm.member_analyse_income_total_zone_yearly_all;


CREATE TABLE IF NOT EXISTS ads_crm.member_analyse_income_total_zone_yearly_all (
    brand                   VARCHAR,
