INSERT INTO ads_crm.member_analyse_income_total_all
    WITH tt AS (
        SELECT
            brand_name,
            {zone},
            IF (order_channel IS NULL, '全部', order_channel),
        ...
        SELECT
            ...
            ss.{zone},
            ss.member_type,
            IF (ss.order_channel IS NULL, '全部', ss.order_channel),
        ...
        SELECT
            ...
            ss_l.{zone},
            ss_l.member_type,
            IF (ss_l.order_channel IS NULL, '全部', ss_l.order_channel),
        ...
        SELECT DISTINCT
            ...
            f.{zone},
            f.member_type,
            IF (f.order_channel IS NULL, '全部', f.order_channel),
